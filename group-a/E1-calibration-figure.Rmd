...
```{r E1-calibration-figure, echo=FALSE, fig.cap="Calibration and validation point locations for Experiment 1. Black points were used for calibration. Red crosses were used for checking the accuracy of the calibration.", fig.width=6, fig.height=4}
