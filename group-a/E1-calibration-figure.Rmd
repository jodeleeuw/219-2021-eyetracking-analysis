...
```{r E1-calibration-figure, echo=FALSE, warning=FALSE, fig.cap="Calibration and validation point locations for Experiment 1. Black points were used for calibration. Red crosses were used for checking the accuracy of the calibration. The inner validation crosses on the left side are shifted to the left of the corresponding calibration points by 10% due to an error in the code.", fig.width=6, fig.height=4}
