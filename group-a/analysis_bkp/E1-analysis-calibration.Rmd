...
Participants' calibration quality was measured as the mean percentage of fixations that landed within 200 pixels of the calibration point. Calibration quality varied widely, ranging from `r min(calib.by.subj$mean_percent_in_roi) %>% round(digits = 2)`%) to `r max(calib.by.subj$mean_percent_in_roi) %>% round(digits = 2`%. 
