...
```
```{r E1b-calib-effect, fig.cap='Calibration scores in Exp. 1b, plotted against the verb effect, operationalized as the latency of the first target fixation in the non-restricting verb condition minus that in the restricting verb condition.'}
