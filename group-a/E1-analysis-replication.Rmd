...
```{r E1-calib-effect, fig.cap='Calibration scores plotted against the verb effect on first fixations (the latency of the first target fixation in the non-restricting verb condition minus that in the restricting verb condition).'}
