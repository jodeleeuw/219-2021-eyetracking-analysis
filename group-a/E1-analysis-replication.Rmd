...
```{r E1-spaghetti-fig, fig.cap = "Cumulative probability of fixating distractor and target objects across conditions. The vertical line marks the mean noun onset across trials and conditions."} 
...
```{r E1-latency-table-min, echo=FALSE, eval=FALSE}
