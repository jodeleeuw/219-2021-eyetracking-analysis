...
We calculated the proportion of gaze samples in the ROI of the unfamiliar image out of all the gaze samples that were in either ROI. Of the `r looking.score.data %>% nrow()` trials in the experiment, `r looking.score.data %>% filter(is.nan(looking.score)) %>% nrow()` had no fixations in either ROI and so were excluded from this analysis. 
