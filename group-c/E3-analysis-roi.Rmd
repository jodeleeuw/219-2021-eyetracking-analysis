...
The correlation between looking scores using the ROI method and the halves method is `r ls.cor`.
...
```{r E3-roi Plot of cumulative looking score, echo=FALSE, fig.cap="Cumulative looking score over the 5 second exposure during part 2 of day 1. Error bars represent +/- 1 SEM."}
