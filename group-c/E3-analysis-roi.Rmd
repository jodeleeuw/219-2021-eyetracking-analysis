...
Above we excluded looks that fell outside the ROIs. In contrast, the original experiment simply coded looks as being to the left or right. This may be more appropriate to the limited resolution of camera-based eye-gaze detection. We re-ran analyses based on this split-half coding criterion. The correlation between looking scores using the ROI method and the halves method is `r ls.cor` (see Figure\ \@ref(fig:E3-roi-correlation-of-looking-score)).

```{r E3-roi-correlation-of-looking-score, echo=FALSE, fig.cap="Correlation between looking scores calculated using ROIs and using screen halves.", out.width="50%", fig.align="center"}
