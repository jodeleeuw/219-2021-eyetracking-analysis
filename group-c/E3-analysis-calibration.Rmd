...
```{r E3-cal-Plot-looking-score-roi-by-calibration, echo=FALSE, warning=FALSE, fig.cap = 'Calibration scores plotted against looking scores using the ROI coding method (proportion of gaze samples to the new image out of all gaze samples).', out.width="50%", fig.align="center"}
