...
```{r E4-gaze-timecourse-fig-quadrants, fig.cap = "Timecourse of eye-gaze to target animal and target instrument by verb bias condition. Gaze was categorized based on which quadrant of the screen the coordinates fall in (as opposed to a bounding box around the image). Vertical lines indicate average onsets of animal and instrument offset by 200ms.", out.width="50%", fig.align="center"}
