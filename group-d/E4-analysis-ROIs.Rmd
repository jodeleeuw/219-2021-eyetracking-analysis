...
eyetracking.data.with.roi <- eyetracking.data %>%
  ...
  mutate(in.roi.0 = in.box(x,y, 0, screen_width/2, 0, screen_height/2, 0)) %>%
  mutate(in.roi.1 = in.box(x,y, screen_width/2, screen_width, 0, screen_height/2, 0)) %>%
  mutate(in.roi.2 = in.box(x,y, 0, screen_width/2, screen_height/2 , screen_height, 0)) %>%
  mutate(in.roi.3 = in.box(x,y, screen_width/2, screen_width, screen_height/2 , screen_height, 0)) %>% 
