...
```{r E4-calib-corr-plot, fig.cap= 'Calibration scores plotted against the verb bias effect (the difference in target animal fixations between modifier and instrument conditions).'}
