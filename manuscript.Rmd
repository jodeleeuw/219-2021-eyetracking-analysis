...
which was achievable for about 37% of the participants 
(Figure\ \@ref(fig:AS-polling-rate)).
...
validation steps. However, even participants with low calibration accuracy were allowed to complete the experiment, because we specifically wanted to study the consequences of low calibration accuracy.<!--If the second attempt also lead to low validation
...
[^1]: The WebGazer.js patch can be found at https://github.com/brownhci/WebGazer/commit/35301e56c192ef265bb270873a6526205f183711. 
