...
```{r E1-analysis-replication,eval=FALSE, child = 'group-a/E1-analysis-replication.Rmd'}

```

#### Calibration
```{r E1-analysis-calibration,eval=FALSE, child = 'group-a/E1-analysis-calibration.Rmd'}
```

### In-lab sample
```{r E1-analysis-JoshH-lab,eval=FALSE, child = 'group-a/E1-analysis-comparison-to-Hartshorne.Rmd'}
