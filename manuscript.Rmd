...
calibration dots were specific to each experiment (details in each experiment's Procedure section) and
...
fixated the dots as they appeared in different locations on the screen. Validation points were the same as or a subset of the calibration points, with one exception in which two points were slightly offset by mistake (see Experiment 1a Procedure). We chose to align the calibration and validation points (rather than test the calibration model on new points) because we were interested in the most basic test of consistency. 
...
validation steps. However, even participants with low calibration accuracy after their second attempt were allowed to complete the experiment, because we specifically wanted to study the consequences of low calibration accuracy.
