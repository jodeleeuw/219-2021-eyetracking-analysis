...
We used a novel port of the `webgazer.js` library for webcam eyetracking [@papoutsaki2016webgazer], implemented in `jsPsych`, a Javascript library for running behavioral experiments
in a web browser [@deleeuwJsPsychJavaScriptLibrary2015]. We made several changes to webgazer.js in order to improve data quality. FUBAR
