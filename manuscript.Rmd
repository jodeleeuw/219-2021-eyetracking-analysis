...
world paradigm with "natural" scenes). As noted above, we had a preference for well-established findings that are known to replicate, though for sake of diversity this was not always possible. TABLE X provides an overview of the five studies we selected.

```{r Create Studies Table, echo=FALSE}
