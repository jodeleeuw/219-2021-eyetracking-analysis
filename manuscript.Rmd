...
<!--AJ: I don't know what the above comment means. -->
<!--RR: I think it's referencing that the scripts in the OSF repository are the ones the students use for their class projects and not the ones that produced the results in the paper which is maybe confusing but I can add some description above about how these data were collected in a classrooom setting. -->
