...
Taken together, the instability of these effects might suggest that this paradigm is not well-suited for webcam-based eye-tracking. Notably, the ROIs were tightly drawn around the five to six objects in each scene (larger ROIs would have led to overlapping objects) and thus, analyses were unforgiving of inaccurate calibration. Further evidence comes from [@prystauka2023online], who ran a modified version of the Altmann and Kamide study with only 4 objects, allowing larger, more distinct ROIs.
 ...
 • Effect sizes (target adv in eat vs. move cond) were uncorrelated with calibration accuracy in both samples, but in the remote sample (but not JH lab), calibration was correlated with target adv in eat condition alone [I need to look into this real quick--I think scatterplots would help]
