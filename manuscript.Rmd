...
# the presence of this chunk separate from the replication analysis was somehow causing the figures to disappear so I copied the calibration rmd content into the analysis-replication rmd and this solved the problem.
```--->

### In-lab sample

<!---
test figure \@ref(fig:test)

```{r test, fig.cap = "test plot"}
