...
```{r E2-rt-acc-fig, fig.cap = "Accuracy and response times during memory retrieval by statement type and viewing condition in Experiment 2.", out.width="50%", fig.align="center"}
