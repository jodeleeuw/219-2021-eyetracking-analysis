...
view.summary.condition1.data <- view.summary.subject.data %>%
  ...
  summarize(M = mean(proportion), SE = sd(proportion) / sqrt(n()))
```
```{r E2-gaze-fig-both-conds, fig.cap = "Proportion of eye-gaze to critical quadrant and other three quadrants during memory retrieval in a) fixed and b) free viewing conditions.", out.width="50%", fig.align="center"}
...
```{r E2-gaze-fig-fixed, fig.cap = "Proportion of eye-gaze to critical quadrant and other three quadrants durign memory retrieval.", eval = F, out.width="50%", fig.align="center"}
...
```{r E2-rt-acc-fig, fig.cap = "Accuracy and response times during memory retrieval.", out.width="50%", fig.align="center"}
