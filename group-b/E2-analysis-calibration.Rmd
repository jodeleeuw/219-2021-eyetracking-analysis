...
```{r E2-calib-effect, fig.cap = 'Calibration scores plotted against gaze bias (the difference between the proportion of looks to the critical quadrant minus the average proportion of looks to the average of the other three quadrants).', out.width="50%", fig.align="center"}
