...
plot.AR<-ggplot(summary.gaze.view, aes(x=time.window, y=prop.in.target, color=task))+
...
(ref:groupEMain-caption-separate) Primary results from Exp. 5. The attractiveness judgment along with the best-fitting sigmoid  is shown on the *left*. Results for the roundness judgment are shown on the *right*, with the best-fitting sigmoid for the attractiveness judgment depicted in a dashed line for comparison.

(ref:groupEMain-caption) Primary results from Exp. 5. The proportion of fixations to the target in the two seconds prior to the judgment are shown for the attractiveness (red) and roundness (blue) conditions along with their best-fitting sigmoids. 

```{r groupEMain, fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "(ref:groupEMain-caption)"}
