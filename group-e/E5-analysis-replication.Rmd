...
# All defaults
include_graphics("figGroupEOrigA")
include_graphics("figGroupEOrigB")
plot.A
plot.R
```

Following Shimojo and colleagues, data for each condition were fit using a four-parameter sigmoid (Fig. \@ref(fig:Shimojo)). These fit less well than in the original paper for both the attractiveness judgment (R^2^ = `r round(R2.A,2)` vs. 0.91) and the roundness judgment (R^2^ = `r round(R2.R,2)` vs. 0.91). 
