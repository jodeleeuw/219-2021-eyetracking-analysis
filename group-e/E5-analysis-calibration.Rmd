...
(ref:groupEMainrev-caption) Revised results for Exp. 5 after removing low-calibration accuracy participants. The proportion of fixations to the target in the two seconds prior to the judgment are shown for the attractiveness (red) and roundness (blue) conditions along with their best-fitting sigmoids.

```{r groupEMainrev, fig.show="hold", fig.align="center", echo=FALSE, message=FALSE, warning=FALSE, fig.cap = "(ref:groupEMainrev-caption)"}
#plot.A
#plot.R
plot.AR
```
