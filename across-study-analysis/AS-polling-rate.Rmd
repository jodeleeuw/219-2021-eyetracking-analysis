...
```{r AS-polling-rate-load-libraries, include=FALSE}
library(dplyr)
library(jsonlite)
library(tidyr)
library(ggplot2)
...
```{r polling-rate-figure, include=TRUE, echo=FALSE, fig.cap="Achieved polling rate across all studies. We attempted to sample at 30Hz, which is a standard webcam refresh rate. The plurality of participants met this rate, but there was a long tail of slower rates.",out.width="50%", fig.align="center"}
