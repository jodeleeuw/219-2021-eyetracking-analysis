...
```{r plot-polling-rate, include=TRUE, echo=FALSE, fig.cap="Achieved polling rate across all studies. We attempted to sample at 30Hz, which is a standard webcam refresh rate. The plurality of participants met this rate, but there was a long tail of slower rates.}
