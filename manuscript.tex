...
of Simonsohn (\textbf{simonsohn215?}). In study 5, the original sample size was so
...
Yang and Krajbich (2021) reported improved the sampling rate in their study of
...
(\url{https://osf.io/k63b9/}). The pre-registration for the study can be
found at \url{https://osf.io/48jsv} (\url{https://osf.io/48jsv}). We
...
\begin{figure}
\centering
\includegraphics{manuscript_files/figure-latex/unnamed-chunk-36-1.pdf}
\caption{\label{fig:unnamed-chunk-36}Calibration and validation point locations for Experiment 3. Black points were used for calibration. Red crosses were used for checking the accuracy of the calibration.}
\end{figure}
